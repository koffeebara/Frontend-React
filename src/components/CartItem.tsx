    ...
    <div>
      ...
      <div className="flex gap-8 items-center">
        ...
        <div className="flex-1">
          ...
          <p className="font-semibold my-2">달콤하고 신선한 친환경 옥수수</p>
          <p className="font-bold text-[20px] text-mint-700 my-3">
          ...
          <div className="flex items-center mt-2 gap-2">
            <div className='border border-gray-300'>
              <button
                ...
                className="w-8 h-8 bg-gray-200 text-lg text-gray-600"
              >
                -
              </button>
