export default function Footer() {
  return (
    <footer className="w-full self-stretch py-7 bg-mint-700 inline-flex flex-col justify-end items-center gap-4">
      <div className="text-center justify-start text-gray-000 text-xs font-light font-['pretendard'] leading-none">
      ...
      <div className="w-36 h-3.5 relative">
        <div className="left-0 top-0 absolute text-center justify-start text-mint-900 text-[10px] font-['pretendard'] leading-none">
          © Team. coffeebara ☕️
        </div>
      </div>
    </footer>
