  ...
  return (
    <>
      <div className='w-full h-max p-8'>
        ...
        <Link
          to="/mypage"
          className="text-green-700 w-full text-left cursor-pointer m-4 my-2"
        >
          &lt; 마이페이지
        </Link>

        {/* 작물명 */}
        <div className="flex flex-col items-center bg-white border border-gray-300 rounded-2xl p-8 mb-8 mt-4">
          <img src="/tomatoes.jpg" alt="" className="w-[120px] h-[120px] rounded-full my-4" />
          <p className="text-[24px] font-bold text-mint-700">토마토</p>
          <p className="text-gray-500 text-sm my-4">{farmer}님의 작물 일지를 확인해 보세요!</p>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <SummaryCard title="재배 진행률" summary="80%" />
            <SummaryCard title="참여자" summary="152명" />
            <SummaryCard title="재배 기간" summary="90일" />
            <SummaryCard title="진행 중" summary="~ 17일" />
          </div>
        </div>
        <div>
