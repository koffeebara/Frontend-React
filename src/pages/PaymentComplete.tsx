  ...
  return (
    <>
      <div className="flex flex-col p-4 gap-4 ">
        <div className="flex flex-col items-center w-full h-[264px] bg-green-000 rounded-2xl ">
          <p className="text-[40px] pt-10 pb-4">✅</p>
          <p className="text-[40px] mb-4">결제가 완료됐습니다!</p>
          <p className="text-gray-400">{farmer}님의 {item} 공동 위탁에 성공적으로 참여하셨습니다. </p>
        ...
        <div className="flex flex-col w-full h-max bg-white rounded-2xl p-4 gap-8 mb-8">
          ...
          {/* 진행 단계 안내 */}
          <div className="p-8 bg-green-000 rounded-2xl">
          ...
          <button className="bg-gray-100 text-gray-600 rounded-xl h-15 mb-8">농장 일지 미리보기</button>
        </div>
      </div>
    </>
  )
